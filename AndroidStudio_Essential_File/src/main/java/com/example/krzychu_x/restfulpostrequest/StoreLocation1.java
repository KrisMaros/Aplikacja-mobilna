...
public class StoreLocation1 extends AppCompatActivity {
    ...
    //GroceryShoppingSystemDEMO/webresources/

    String url = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie1/2";
    String url1 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie1/3";
    String url2 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.store/1";
    String url3 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie1/4";
    String url4 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie1/5";
    String url5 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie1/101";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_store_location1);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Edit1.class);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Delete1.class);
                startActivity(startIntent);
            }
        });
        create.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Create1.class);
                startActivity(startIntent);
            }
        });
        getProduct1();
