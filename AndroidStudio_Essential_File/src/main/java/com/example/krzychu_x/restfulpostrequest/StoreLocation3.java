...
public class StoreLocation3 extends AppCompatActivity {
    ...
    String url = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie3/1";
    String url1 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie3/2";
    String url2 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.store/3";
    String url3 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie3/3";
    String url4 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie3/4";
    String url5 = "http://10.0.2.2:8080/AndroidRestfulServer/webresources/web.grocerie3/5";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_store_location3);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Edit3.class);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Delete3.class);
                startActivity(startIntent);
            }
        });
        ...
        create.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), Create3.class);
                startActivity(startIntent);
            }
        });
